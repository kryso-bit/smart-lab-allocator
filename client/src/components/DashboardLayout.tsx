...
import { BarChart3, Bot, CalendarDays, Database, Factory, FileUp, LayoutDashboard, ListChecks,  PanelLeft, Settings2 } from "lucide-react";
...
function DashboardLayoutContent({
  ...
  const user = { name: "Public viewer", role: "public" as const };
          ...
          <SidebarFooter className="p-3">
            <div className="flex items-center gap-3 rounded-lg px-1 py-1 w-full text-left">
              ...
              <div className="flex-1 min-w-0 group-data-[collapsible=icon]:hidden">
                <p className="text-sm font-medium truncate leading-none">Public viewer</p>
                <p className="text-xs text-muted-foreground truncate mt-1.5">Open access</p>
              </div>
            </div>
          </SidebarFooter>
        </Sidebar>
