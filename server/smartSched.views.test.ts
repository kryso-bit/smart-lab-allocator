...
import { groupScheduleByView } from "../client/src/lib/scheduleViews";
...
describe("SmartSched timetable view modes", () => {
  it("executes flat grid and distinct room/faculty groupings", () => {
